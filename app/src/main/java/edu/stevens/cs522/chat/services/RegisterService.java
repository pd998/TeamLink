                ...
                mainLoop.post(() -> {
                    ...
                    if (registerResponse != null && !(registerResponse instanceof ErrorResponse)) {
                        // TODO let user know request succeeded (with another notification)
                         notificationBuilder.setContentTitle(getText(R.string.register_notification_title))
                                        .setContentText(getText(R.string.register_success))
                                        .setSmallIcon(R.drawable.ic_chat)
                                        .setContentIntent(pendingIntent)
                                        .setTicker(getText(R.string.register_ticker_text))
                                        .setSmallIcon(R.drawable.ic_chat);
                        startForeground(registerNotificationId, notificationBuilder.build());

                    } else {
                        // TODO let user know request failed (with another notification)
                        notificationBuilder.setContentTitle(getText(R.string.register_notification_title))
                                .setContentText(getText(R.string.register_failed))
                                .setSmallIcon(R.drawable.ic_chat)
                                .setContentIntent(pendingIntent)
                                .setTicker(getText(R.string.register_ticker_text))
                                .setSmallIcon(R.drawable.ic_chat);
